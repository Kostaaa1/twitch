...
func Hero() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex py-16 px-4 items-center justify-center flex-col text-white flex-wrap text-center gap-3\"><h1 class=\"text-5xl md:text-7xl font-semibold\">Download Twitch media</h1><h3 class=\"text-xl md:text-3xl\">Download media from twitch.tv</h3><div class=\"flex w-[80vw] max-w-[800px] mt-3\"><input id=\"twitchUrl\" name=\"twitchUrl\" class=\"w-full bg-white placeholder:text-slate-400 text-slate-700 border border-slate-200 rounded-l-full px-6 p-3 transition duration-300 ease text-lg focus:outline-none hover:border-slate-300 shadow-sm focus:shadow\" placeholder=\"Paste twitch.tv URL &amp; Download\" autofocus=\"true\" value=\"https://www.twitch.tv/videos/2295067647?filter=archives&amp;sort=time\">")
		if templ_7745c5c3_Err != nil {
...
func Home() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex items-center justify-center flex-col\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
