...
// 	g.Go(func() error {
// 		downloadGroun, ctx := errgroup.WithContext(ctx)
// 		if len(twitchUnits) > 0 {
// 			startTwitchDownloader(ctx, tw, spin, flag, twitchUnits, downloadGroun)
// 		}
// 		if len(kickUnits) > 0 {
// 			startKickDownloader(ctx, spin, flag.Threads, kickUnits, downloadGroun)
// 		}
// 		downloadGroun.Wait()
// 		cancel()
// 		return nil
