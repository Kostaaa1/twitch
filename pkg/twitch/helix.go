...
func (h *Helix) Request(
	...
	for {
		...
		req.Header.Set("Authorization", fmt.Sprintf("Bearer %s", h.oauthCreds.AccessToken))
		...
		if resp.StatusCode == http.StatusUnauthorized {
			...
			if err := h.AccesToken(ctx); err != nil {
...
func (h *Helix) UserByChannelName(ctx context.Context, channelName string) (*User, error) {
...
func (h *Helix) UserByID(ctx context.Context, id string) (*User, error) {
...
func (h *Helix) ChannelInfo(ctx context.Context, broadcasterID string) (*Channel, error) {
...
func (h *Helix) FollowedStreams(ctx context.Context, id string) (*[]Stream, error) {
...
func (h *Helix) Stream(ctx context.Context, userId string) (*[]Stream, error) {
